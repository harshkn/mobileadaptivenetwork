...
%         alpha = 0.5;
        ...
        no = noval(merged)% (0 - No cooperation) 
...
for iter = 1:ITERATIONS
    ...
    for k = 1:N % loop not required, test and remove
        ...
        v(:,k) = (lambda * h( w_n(:,k),x_n(k,:)' ,1))...
            ...
            + gamma(1,k) * Delta(x_n',nl,k,1);
            %+ gama(1,k) * Delta(x_n',nl,k,1);
